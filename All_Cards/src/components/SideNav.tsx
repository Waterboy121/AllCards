     ...
     <div className="justify-content-between align-items-center text-white">
        ...
        */
        ...
        <nav className="nav nav-tabs nav-justified">
          ...
          <Link to="/Home" className="nav-link anta-regular fs-4 text-white" key="home" >
            Home
          </Link>
          <Link to="/" className="nav-link anta-regular fs-4 text-white align-items-center" key="aboutus" >
          <img src={PokemonIcon} className="me-2 mb-1" width="25" height="25" />
            Pokemon
          </Link>
          <Link to="/" className="nav-link anta-regular fs-4 text-white align-items-center" key="login" >
            <img src={YuGuHoIcon} className="me-2 mb-1" width="30" height="30" />
            Yu-Gu-Oh!
          </Link>
